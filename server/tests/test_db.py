...
def test_upsert_papers_insert(tmp_db_path: Path, sample_paper):
...
def test_set_paper_status(tmp_db_path: Path, sample_paper):
...
def test_get_unread_papers(tmp_db_path: Path, sample_papers):
...
def test_list_papers_filter_by_track(tmp_db_path: Path, sample_papers):
...
def test_list_papers_search_keyword(tmp_db_path: Path, sample_papers):
...
def test_list_papers_sort_and_pagination(tmp_db_path: Path, sample_papers):
...
def test_get_paper_by_id_or_title(tmp_db_path: Path, sample_paper):
...
def test_save_recommendation(tmp_db_path: Path, sample_papers):
...
def test_get_recent_reads(tmp_db_path: Path, sample_papers):
...
def test_paper_notes(tmp_db_path: Path, sample_paper):
...
def test_get_stats_counts(tmp_db_path: Path, sample_papers):
...
def test_paper_translation_cache(tmp_db_path: Path, sample_paper):
...
def test_paper_pdf_cache(tmp_db_path: Path, sample_paper):
